// src/features/products/pages/StatCard.jsx
...
const StatCard = ({ icon: Icon, label, value, valueColor = 'text-text-primary', accentColor = 'bg-app-surface-alt', children }) => (
    <div className="relative flex items-center gap-3 p-3 group">
        ...
        <div className={`relative flex items-center justify-center w-8 h-8 rounded-lg ${accentColor} shrink-0 transition-transform duration-300`}>
